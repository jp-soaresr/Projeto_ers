    ...
    <div class="table-moderna-wrapper">
        <table class="table table-moderna">
            ...
            <tbody>
                @forelse ($clientes as $cliente)
                    <tr>
                        ...
                        <td class="text-center">
                            {{-- Botões com novo estilo, mas mantendo as classes JS originais --}}
                            <button class="btn-acao-tabela editar btn-editar-cliente"
                            ...
                            <button class="btn-acao-tabela excluir btn-excluir-cliente"
                ...
                @empty
                    <tr>
                        <td colspan="6" class="text-center" style="padding: 2rem !important; border-bottom: none;">Nenhum cliente cadastrado.</td>
                    </tr>
                @endforelse
            </tbody>
        </table>
